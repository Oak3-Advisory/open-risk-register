...
Risk assessments address the potential adverse impacts to organizational operations and assets,
...
Strategic plans and policies also assert or imply the relative priorities of immediate or near-term
...
(e.g., damage to image or reputation of the organization or financial loss at Tier 1; inability to
successfully execute a specific mission/business process at Tier 2; or the resources expended in
...
descriptions of vulnerabilities in the systems, an assessment of the risks associated with each
...
Sharing Environment [DCISE], Information Sharing and Analysis Centers [ISACs] for critical infrastructure sectors),
...
2.  Committee on National Security Systems Instruction (CNSSI) No. 4009, National

Information Assurance (IA) Glossary, April 2010.

3.  Committee on National Security Systems Instruction (CNSSI) No. 1253, Security
Categorization and Control Selection for National Security Systems, March 2012.

4.  Department of Homeland Security Federal Continuity Directive 2 (FCD 2), Federal

Executive Branch Mission Essential Function and Primary Mission Essential Function
...
6.  National Institute of Standards and Technology Special Publication 800-53A, Revision 1,
...
10.  National Institute of Standards and Technology Special Publication 800-65, Integrating

IT Security into the Capital Planning and Investment Control Process, January 2005.

11.  National Institute of Standards and Technology Special Publication 800-70, Revision 2,
National Checklist Program for IT Products--Guidelines for Checklist Users and
Developers, February 2011.

12.  National Institute of Standards and Technology Special Publication 800-117, Version 1.0,
Guide to Adopting and Using the Security Content Automation Protocol (SCAP), July
2010.

13.  National Institute of Standards and Technology Special Publication 800-126, The

Technical Specification for the Security Content Automation Protocol (SCAP): SCAP
Version 1.0, November 2009.

14.  National Institute of Standards and Technology Special Publication 800-137, Information
...
Adversary uses commercial or free software to scan organizational perimeters to
...
Adversary with access to exposed wired or wireless data channels used to transmit
...
Adversary uses malware installed inside the organizational perimeter to identify
...
Adversary counterfeits communications from a legitimate/trustworthy source to
...
Adversary employs phishing attacks targeted at high value targets (e.g., senior
leaders/executives).
...
Adversary creates duplicates of legitimate websites; when users visit a counterfeit
site, the site can gather information or download malware.

Adversary counterfeits or compromises a certificate authority, so that malware or
...
Adversary places individuals within organizations who are willing and able to carry
...
Adversary takes advantage of external organizational or personal information
...
Adversary, with processes running in an organizationally-used cloud environment,
...
Adversary circumvents or defeats isolation mechanisms in a multi-tenant
...
Compromise mission-critical information.

Compromise design, manufacture, and/or distribution of
information system components (including hardware,
software, and firmware).

Adversary compromises the integrity of mission-critical information, thus preventing
...
Adversary takes measures to interfere with wireless communications so as to
...
Adversary attempts to make an Internet-accessible resource unavailable to intended
...
Conduct targeted Denial of Service (DoS) attacks.

Adversary targets DoS attacks to critical information systems, components, or
...
Adversary conducts a physical attack on organizational facilities (e.g., sets a fire).
...
Conduct nontargeted zero-day attacks.

Adversary employs attacks that exploit as yet unpublicized vulnerabilities. Attacks
...
Adversary directs malware on organizational systems to locate and surreptitiously
...
Adversary with authorized access to organizational information systems, gains
...
Adversary takes actions to inhibit the effectiveness of the intrusion detection
systems or auditing capabilities within organizations.

Adapt cyber attacks based on detailed surveillance.

Adversary adapts behavior in response to surveillance and organizational security
measures.
...
Display unreadable due to aging equipment.
...
Fire (not due to adversarial activity) at primary facility makes facility inoperable.

Fire at backup facility

Fire (not due to adversarial activity) at backup facility makes facility inoperable or destroys backups of software,
...
Degraded processing performance due to resource depletion.
...
Corrupted storage due to a disk error.

Pervasive disk error

Multiple disk errors due to aging of a set of devices all acquired at the same time, from the same supplier.
...
The threat event or TTP has been seen by the organization.
...
The threat event or TTP has been reported by a trusted source.

Predicted

The threat event or TTP has been predicted by a trusted source.

Possible

The threat event or TTP has been described by a somewhat credible source.

N/A

The threat event or TTP is not currently applicable. For example, a threat event or TTP could assume specific technologies,
...
Type of Predisposing Condition
...
Identify threat event. (Task 2-2; Table E-1; Table E-2; Table E-5; Table I-5.)

Identify threat sources that could initiate the threat event. (Task 2-1; Table D-1; Table D-2;
Table D-7; Table I-5.)

Assess threat source capability. (Task 2-1; Table D-3; Table D-7; Table I-5.)

Assess threat source intent. (Task 2-1; Table D-4; Table D-7; Table I-5.)

Assess threat source targeting. (Task 2-1; Table D-5; Table D-7; Table I-5.)

Determine relevance of threat event. (Task 2-2; Table E-1; Table E-4; Table E-5; Table I-5.)
...
Determine likelihood that one or more of the threat sources initiates the threat event, taking into
...
Determine the likelihood that the threat event will be initiated and result in adverse impact (i.e.,
...
Determine the adverse impact (i.e., potential harm to organizational operations, organizational
...
Determine the level of risk as a combination of likelihood and impact. (Task 2-6; Table I-1;
...
Identify threat event. (Task 2-2; Table E-1; Table E-3; Table E-5; Table I-7.)
...
Identify the range of effects from the threat source. (Task 2-1; Table D-1; Table D-6; Table I-7.)

Relevance

Determine relevance of threat event. (Task 2-2; Table E-1; Table E-4; Table E-5; Table I-7.)
If the relevance of the threat event does not meet the organization’s criteria for further
consideration, do not complete the remaining columns.
...
Determine the likelihood that the threat event will occur and result in adverse impacts (i.e.,
...
Determine the level of risk as a combination of likelihood and impact. (Task 2-6; Table I-1; Table
