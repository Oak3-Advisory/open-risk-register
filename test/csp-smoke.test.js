...
const csp = "default-src 'self'; script-src 'self' https://cloud.umami.is; style-src 'self'; img-src 'self' data:; font-src 'self'; connect-src https://cloud.umami.is https://gateway.umami.is; object-src 'none'; base-uri 'none'; form-action 'none'; upgrade-insecure-requests";
